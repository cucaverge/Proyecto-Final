...
public class InvoiceService {
    ...
    public InvoiceDTO postInvoice (RequestInvoice requestInvoice) throws Exception {
        ...
        for (Product product:
            ...
            if (product.getStock() >= requestInvoice.getProduct_list().get(i).getQuantity()){
                product.setStock(product.getStock() - requestInvoice.getProduct_list().get(i).getQuantity());
            }else{
    ...
    public InvoiceWithDetailsDTO getInvoiceById (int invoice_id) throws Exception {
        ...
        return new InvoiceWithDetailsDTO(
                ...
                invoiceFound.get().getClient().getId(), invoiceFound.get().getCreated_at(),
